...
static void MX_ADC1_Init(void)
{
  ...
  hadc1.Init.ExternalTrigConv = ADC_EXTERNALTRIGCONV_T2_CC2; //ADC_EXTERNALTRIGCONV_T2_TRGO;
...
static void MX_ADC3_Init(void)
{
  ...
  hadc3.Init.ExternalTrigConv = ADC_EXTERNALTRIGCONV_T4_CC4; //ADC_EXTERNALTRIGCONV_T4_TRGO;
